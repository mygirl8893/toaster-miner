...
static enum algos opt_algo = ALGO_CRYPTOUPX;
...
static void *miner_thread(void *userdata)
{
	...
	/*	case ALGO_BLAKE:
			...
			break; */
		case ALGO_CRYPTOUPX:
			rc = scanhash_cryptoupx(thr_id, &work, max_nonce, &hashes_done);
			break;
/*		case ALGO_KECCAK:
		case ALGO_KECCAKC:
...
#ifdef HAVE_SYSLOG_H
	if (use_syslog)
		openlog("toasterminer", LOG_PID, LOG_USER);
#endif
